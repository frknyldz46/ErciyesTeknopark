...
const App = (props) => {
  Item = ({ title }) => {
    return (
      <View>
        <ImageBackground style={styles.resim} source={require("./11.jpeg")}>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Söyle</Text>
            <Text style={styles.sarkiadialt}>Mentra & Pera</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Adım Yok</Text>
            <Text style={styles.sarkiadialt}>yirmi7</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Lalala</Text>
            <Text style={styles.sarkiadialt}>Piiz</Text>
          </View>
        </View>
        <View style={styles.seperator} />
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Hayret</Text>
            <Text style={styles.sarkiadialt}>Adamlar</Text>
          </View>
        </View>
        <View style={styles.seperator} />
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Kayıp Nesil</Text>
            <Text style={styles.sarkiadialt}>Geceyi Kurtar</Text>
          </View>
        </View>
        <View style={styles.seperator} />
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Yarına Sakla</Text>
            <Text style={styles.sarkiadialt}>bodes</Text>
          </View>
        </View>
        <View style={styles.seperator} />
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Sentetik Melek</Text>
            <Text style={styles.sarkiadialt}>Ben Ölünce</Text>
          </View>
        </View>
        <View style={styles.seperator} />
