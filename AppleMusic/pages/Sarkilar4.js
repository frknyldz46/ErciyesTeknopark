    ...
    return (
      <View>
        ...
        <View style={styles.textcerceve}>
          ...
          <Text style={styles.title2}>Apple Music:High Drama</Text>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Cracker Island </Text>
            <Text style={styles.sarkiadialt}>Adam Lambert</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Oil (feat.Stevie Nicks)</Text>
            <Text style={styles.sarkiadialt}>Adam Lambert</Text>
          </View>
        </View>
        <View style={styles.seperator} />
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>The Tired Influencer </Text>
            <Text style={styles.sarkiadialt}>Adam Lambert</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Silent Running</Text>
            <Text style={styles.sarkiadialt}>Adam Lambert</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>New Gold</Text>
            <Text style={styles.sarkiadialt}>Adam Lambert</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Baby Queen</Text>
            <Text style={styles.sarkiadialt}>Adam Lambert</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Tarantula</Text>
            <Text style={styles.sarkiadialt}>Adam Lambert</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Tormenta</Text>
            <Text style={styles.sarkiadialt}>Adam Lambert</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Skinny Ape</Text>
            <Text style={styles.sarkiadialt}>Adam Lambert</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Possession</Text>
            <Text style={styles.sarkiadialt}>Adam Lambert</Text>
          </View>
        </View>

        <View style={styles.view_1}>
          <Text style={styles.title}>Diğer Lambert Eserleri</Text>
          <TouchableOpacity>
