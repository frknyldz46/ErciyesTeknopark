...
const DATA = [
  {
    ...
    title: "Zirvedekiler:Türkçe Alternatif",
  },
];
const App = (props) => {
  const Item = ({ title }) => {
    return (
      <View>
        <Image style={styles.resim} source={require("./33.jpeg")} />
        <Text style={styles.title1}>{title}</Text>
        <Text style={styles.title2}>Apple Music:Alternatif</Text>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Sızı</Text>
            <Text style={styles.sarkiadialt}>Cem Adrian</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Dipsiz Deniz</Text>
            <Text style={styles.sarkiadialt}>Genç Osman</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Sokak Lambası </Text>
            <Text style={styles.sarkiadialt}>Dilay Dal</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Kolay Mı?</Text>
            <Text style={styles.sarkiadialt}>Melis Karaduman</Text>
          </View>
        </View>
        ...
        <View style={styles.card1}>
          ...
          <View style={styles.card2}>
            <Text style={styles.sarkiadi}>Gunchik</Text>
            <Text style={styles.sarkiadialt}>Joseph Abbas</Text>
          </View>
        </View>
